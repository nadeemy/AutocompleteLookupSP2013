...
using NY.Autocomplete.LookupField.CONTROLTEMPLATES.NY.Autocomplete.LookupField;

namespace NY.Autocomplete.LookupField.Fields
{
    /// <summary>
    /// A class representing the Autocomplete Lookup field control.
    /// </summary>
    class AutocompleteLookupFieldControl : BaseFieldControl
    {
        ...
        /// </summary>
        private const string autocompleteAscxPath = @"~/_CONTROLTEMPLATES/15/NY.Autocomplete.LookupField/AutocompleteControl.ascx";
