<%@ Assembly Name="NY.Autocomplete.LookupField, Version=1.0.0.0, Culture=neutral, PublicKeyToken=411e771747fbda49" %>
...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AutocompleteControl.ascx.cs" Inherits="NY.Autocomplete.LookupField.CONTROLTEMPLATES.NY.Autocomplete.LookupField.AutocompleteControl" %>
<style>
    .ui-autocomplete {
		max-height: 100px;
		overflow-y: auto;
	...
	* html .ui-autocomplete {
	...
	.ui-autocomplete-loading { background: white url('/_layouts/15/NY.Autocomplete.LookupField/Images/ui-anim_basic_16x16.gif') right center no-repeat; }
</style>
